 ...
 * All generated types are included.
 */
namespace DesmosTypes {
    ...
    export const CreateRelationshipResponse = _CreateRelationshipResponse;
    export type CreateRelationshipResponse = _CreateRelationshipResponse;

    export const MsgDeleteRelationship = _MsgDeleteRelationship;
    export type MsgDeleteRelationship = _MsgDeleteRelationship;

    export const DeleteRelationshipResponse = _DeleteRelationshipResponse;
    export type DeleteRelationshipResponse = _DeleteRelationshipResponse;

    export const MsgBlockUser = _MsgBlockUser;
    export type MsgBlockUser = _MsgBlockUser;

    export const BlockUserResponse = _BlockUserResponse;
    export type BlockUserResponse = _BlockUserResponse;
