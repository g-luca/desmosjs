...
export const AppDescriptor = {
  encode(message: AppDescriptor, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): AppDescriptor {
  ...
  fromJSON(object: any): AppDescriptor {
    ...
    if (object.configuration !== undefined && object.configuration !== null) {
      message.configuration = ConfigurationDescriptor.fromJSON(
    ...
    if (object.queryServices !== undefined && object.queryServices !== null) {
      message.queryServices = QueryServicesDescriptor.fromJSON(
  ...
  fromPartial(object: DeepPartial<AppDescriptor>): AppDescriptor {
    ...
    if (object.configuration !== undefined && object.configuration !== null) {
      message.configuration = ConfigurationDescriptor.fromPartial(
        object.configuration
      )
    } else {
      message.configuration = undefined
    ...
    if (object.queryServices !== undefined && object.queryServices !== null) {
      message.queryServices = QueryServicesDescriptor.fromPartial(
        object.queryServices
      )
    } else {
      message.queryServices = undefined
...
export const TxDescriptor = {
  encode(message: TxDescriptor, writer: Writer = Writer.create()): Writer {
    if (message.fullname !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): TxDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const AuthnDescriptor = {
  encode(message: AuthnDescriptor, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): AuthnDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const SigningModeDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): SigningModeDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
  ...
  fromJSON(object: any): SigningModeDescriptor {
    ...
    if (
      ...
      message.authnInfoProviderMethodFullname = String(
...
export const ChainDescriptor = {
  encode(message: ChainDescriptor, writer: Writer = Writer.create()): Writer {
    if (message.id !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): ChainDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const CodecDescriptor = {
  encode(message: CodecDescriptor, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): CodecDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const InterfaceDescriptor = {
  ...
  fromJSON(object: any): InterfaceDescriptor {
    ...
    if (
      object.interfaceAcceptingMessages !== undefined &&
    ...
    if (
      object.interfaceImplementers !== undefined &&
...
export const InterfaceAcceptingMessageDescriptor = {
  ...
  fromJSON(object: any): InterfaceAcceptingMessageDescriptor {
    ...
    if (
      object.fieldDescriptorNames !== undefined &&
...
export const ConfigurationDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): ConfigurationDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {
  ...
  fromJSON(object: any): ConfigurationDescriptor {
    ...
    if (
      ...
      message.bech32AccountAddressPrefix = String(
...
export const MsgDescriptor = {
  encode(message: MsgDescriptor, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const GetTxDescriptorRequest = {
  encode(_: GetTxDescriptorRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },

  decode(input: Reader | Uint8Array, length?: number): GetTxDescriptorRequest {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const GetTxDescriptorResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): GetTxDescriptorResponse {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {
...
export const QueryServicesDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryServicesDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {
...
export const QueryServiceDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryServiceDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export const QueryMethodDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryMethodDescriptor {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
...
export class ReflectionServiceClientImpl implements ReflectionService {
  ...
  GetAuthnDescriptor(
    ...
    return promise.then((data) =>
      GetAuthnDescriptorResponse.decode(new Reader(data))
    )
  }
  ...
  GetChainDescriptor(
    ...
    return promise.then((data) =>
      GetChainDescriptorResponse.decode(new Reader(data))
    )
  }
  ...
  GetCodecDescriptor(
    ...
    return promise.then((data) =>
      GetCodecDescriptorResponse.decode(new Reader(data))
    )
  }
  ...
  GetConfigurationDescriptor(
    ...
    return promise.then((data) =>
      GetConfigurationDescriptorResponse.decode(new Reader(data))
    )
  }
  ...
  GetQueryServicesDescriptor(
    ...
    return promise.then((data) =>
      GetQueryServicesDescriptorResponse.decode(new Reader(data))
    )
  }
  ...
  GetTxDescriptor(
    ...
    return promise.then((data) =>
      GetTxDescriptorResponse.decode(new Reader(data))
    )
  }
}
